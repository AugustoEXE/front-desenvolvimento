        ...
        <div className="bg-azulzinho-escurinho rounded p-10 z-0 max-xl:mt-5 grid grid-cols-12 text-left ">
          ...
          <div className="col-span-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" value={userData.admin} name="admin" onChange={handleChange} className="sr-only peer " />
          ...
          <button type='button' onClick={handleSubmit} className="col-start-4 col-span-6 bg-laranjinha rounded-full py-1 font-semibold mt-10">Cadastrar Usuário</button>
